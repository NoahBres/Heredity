...
/**
 * ## PerceptronViz
 * Visualizes the neural network/perceptron of PerceptronChromosomes
 *
 * #### Basic usage
 * @example
 * ```html
 ...
 *
 * // Will update on chromosome.compute()
 * ```
 *
 *
 * #### Note:
 ...
 * PerceptronViz will also hook into the NeuralChromosome `compute()` function to update the perceptron viz.
 *
 */
export default class PerceptronViz implements VizClass {
  ...
  constructor(
    ...
    this._disableHooks = disableHooks;
